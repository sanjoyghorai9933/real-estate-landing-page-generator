...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    $("form :input[name=mobile]").each(function () {
        $(this).intlTelInput({ initialCountry: countryCode, preferredCountries: ["in"] });
    });
    ...
    $(".ami-4").owlCarousel({ autoplay: !0, lazyLoad: !0, loop: !1, rewind: !0, margin: 20, responsiveClass: !0, smartSpeed: 1000, nav: !0, dots: !1, responsive: { 0: { items: 1, nav: !1 }, 768: { items: 3, mouseDrag: !1 } } });
